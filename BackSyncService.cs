...
{
    [Service]
    public class BackSyncService : Service
    {
        ...
        {
            //Toast.MakeText(Android.App.Application.Context, "Start Sync", ToastLength.Long).Show();
            try
            {
                Task.Run(async () =>
                {
        ...
        {
            //Toast.MakeText(Android.App.Application.Context, "Service Create", ToastLength.Long).Show();
            //return;
        }
